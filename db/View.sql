...
CREATE VIEW StudentExamTimetable AS
	SELECT DegreeCourse.degree_name AS 'Degree',  Module.module_name AS 'Module', Examination.examination_id AS 'Exam', CONCAT(Users.user_firstname, ' ', Users.user_surname) AS 'Invidulator', Venue.venue_name AS 'Venue', CONVERT(VARCHAR(10), Exam_Venue_Bridge.examination_date, 103)  AS 'Date', CONVERT(VARCHAR(10), CAST(Exam_Venue_Bridge.examination_date AS TIME), 0) AS 'Time' FROM Module
